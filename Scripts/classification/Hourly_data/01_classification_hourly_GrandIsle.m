...
%% Load hourly-derived river residuals and Grand Isle surge
...
OUTDIR = fullfile(BASE_OUTDIR_5CAT,"hourly_with_GrandIsle");
if ~exist(OUTDIR,'dir'); mkdir(OUTDIR); end

save(fullfile(OUTDIR,"TT_dailyall_hourly_with_GI.mat"), ...
    "TT_dailyall");

PLOT_TITLE = ...
    'WL P%d events by 5-category driver classification: hourly WL with Grand Isle';
...
PLOT_FIG_NAME = 'GI_hourly_BAR_AllStations_P%d.fig';
PLOT_PNG_NAME = 'GI_hourly_BAR_AllStations_P%d.png';

COUNTS_FILE = 'Counts_byStation_byPercentile_GI_hourly.mat';
SERIES_FILE = 'Series_byStation_byPercentile_GI_hourly.mat';
