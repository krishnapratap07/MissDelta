...
OUTDIR = fullfile(BASE_OUTDIR_5CAT,"daily_with_CoDEC");
if ~exist(OUTDIR,'dir'); mkdir(OUTDIR); end

save(fullfile(OUTDIR,"TT_dailyall_daily_with_codec.mat"), ...
    "TT_dailyall");

PLOT_TITLE = ...
    'WL P%d events by 5-category driver classification: daily WL with CoDEC';

LEGEND_NAMES = TT_dailyall.Properties.VariableNames( ...
    ~ismember(TT_dailyall.Properties.VariableNames,{'S','Q'}));

PLOT_FIG_NAME = 'CoDEC_daily_BAR_AllStations_P%d.fig';
PLOT_PNG_NAME = 'CoDEC_daily_BAR_AllStations_P%d.png';

COUNTS_FILE = 'Counts_byStation_byPercentile_CoDEC_daily.mat';
SERIES_FILE = 'Series_byStation_byPercentile_CoDEC_daily.mat';
